...
class AboutAttributeAccess(Koan):
    ...
    class WellBehavedFooCatcher(object):
        def __getattribute__(self, attr_name):
            if attr_name[:3] == "foo":
                ...
                return super(AboutAttributeAccess.WellBehavedFooCatcher, self).__getattribute__(attr_name)
    ...
    def test_getattr_only_catches_unknown_attributes(self):
        ...
        self.assertEqual('DuffObject', catcher.give_me_duff_or_give_me_death().__class__.__name__)
